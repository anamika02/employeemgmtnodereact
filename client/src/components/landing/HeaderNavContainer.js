            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="mainNav">
                    <div className="navbar-nav">
                        ...
                        <NavLink className="nav-item nav-link" activeClassName="active" to="/employees" >Employee Management</NavLink>
                        <NavLink className="nav-item nav-link" activeClassName="active" to="/calc">Calculator</NavLink>
